...
namespace timw255.Sitefinity.SuperForms.Widgets.Form
{
    ...
    public sealed class LogicalFormCheckboxes : FormCheckboxes, IConditionalFormControl, IConditionalMaster, IConditionalSlave, IProgressiveFormControl
    {
        ...
        public override IEnumerable<ScriptReference> GetScriptReferences()
        {
            List<ScriptReference> scriptReferences = new List<ScriptReference>(base.GetScriptReferences())
            {
                ...
                new ScriptReference("timw255.Sitefinity.SuperForms.Widgets.Form.LogicalFormCheckboxes.min.js", "timw255.Sitefinity.SuperForms"),
